...
import json
from employee import employee_name,details, title, age


def create_dict(employee_name, age, title):
    ...
    """
    ### WRITE SOLUTION HERE
    return {"first_name":str(employee_name), "age":int(age), "title":str(title) }
